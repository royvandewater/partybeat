...
urlpatterns = patterns('',
    ...
    (r'^library/noajax/(?P<artist>[0-9a-zA-Z\+\-_]+)/$', 'xmms2_django.song_storage.views.library'),
    (r'^library/noajax/(?P<artist>[0-9a-zA-Z\+\-_]+)/(?P<album>[0-9a-zA-Z\+\-_]+)/$', 'xmms2_django.song_storage.views.library'),
